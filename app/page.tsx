...
function getFactionLogoMeta(code: string): FactionMeta {
  ...
  const meta: Record<
    FactionKey,
    Pick<FactionMeta, "icon" | "shape" | "accentWord" | "key">
  > = {
...
function FactionLogoCard({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[30px] bg-gradient-to-br ${faction.colors.bgClass} p-1 shadow-[0_24px_80px_rgba(15,23,42,0.24)]`}
    >
      <div className="relative overflow-hidden rounded-[26px] bg-black/10">
        ...
        <div className="relative grid min-h-[320px] gap-0 md:min-h-[360px] md:grid-cols-[0.9fr_1.1fr]">
          ...
          <div
            className={`relative flex flex-col justify-between bg-gradient-to-b ${faction.colors.panelClass} p-4 text-white sm:p-6 md:p-8`}
          >
            <div>
              ...
              <>
                <div className="block md:hidden">
                  <div className="rounded-[20px] border border-slate-200 bg-white p-4 shadow-sm">
                    ...
                    <h2 className="mt-2 text-2xl font-black text-slate-900">测你是哪一型 BOSS</h2>
